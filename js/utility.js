...
function updateDonationHistory(donationAmount, title) {
    ...
    div.innerHTML = ` <h2 class="font-bold lg:text-xl text-[14px] text-[#111111] mb-4">${donationAmount} Taka is Donated ${title}</h2>
        <p class="font-light lg:text-[16px] text-[12px] ">${d}</p> `
